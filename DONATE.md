...
### Ethereum (ETH)
```
0x443b25BA9Bac6521A8438Fdb01f6617fD82121CF
```

### Bitcoin (BTC)
```
bc1q40pnfk0acyehwhkzfut8nw9s7rvzsn50vtfvyd
```

### Solana (SOL)
```
8xAP7T7PQm9aiXxKUgtzXngxh1diwfjM2EfmSj24DEjb
```

### Tron (TRX)
```
T9z5MjQogjmui248r38Dd6ddZ98F1wBpVk
```
...
- Adding support for more plugins and ecosystems
- Improving performance and detection algorithms
